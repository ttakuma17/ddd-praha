...
//        // Given
//        when(teamRepository.get(testTeamId)).thenReturn(testTeam);
...
//        verify(teamRepository).get(testTeamId);
...
//
//        when(teamRepository.get(testTeamId)).thenReturn(teamWithFourMembers);
...
//        // Given
//        when(teamRepository.get(testTeamId)).thenReturn(null);
//
//        // When & Then
...
//
//        when(teamRepository.get(testTeamId)).thenReturn(Optional.of(teamWithThreeMembers));
...
//
//        when(teamRepository.get(testTeamId)).thenReturn(Optional.of(twoMemberTeam));
//
